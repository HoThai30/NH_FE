...
export default function Dashboard() {
  ...
  return (
    ...
    >
      {/* SIDEBAR */}
      <div
        className="hidden lg:flex w-[250px] border-r border-white/10 flex-col"
        style={{ backgroundColor: "#220202" }}
      >
        {/* LOGO */}
        <div className="px-6 py-7 border-b border-white/10">
          <p className="text-[10px] tracking-[0.25em] uppercase text-yellow-400 font-bold mb-2">
            Nha Khoa Quốc Tế
          </p>

          <h1
            className="text-2xl text-white font-black leading-tight"
        ...
        <div className="flex-1 px-4 py-5 space-y-1 overflow-y-auto">
          {allowedItems.map((item) => (
            <Link
              key={item.path}
              to={item.path}
              className="group flex items-center gap-3 px-3 h-[52px] rounded-2xl text-white/65 hover:text-white transition hover:bg-white/[0.05]"
            >
              <div
        ...
        <div className="p-4 border-t border-white/10">
          ...
          >
            <p className="text-[11px] uppercase tracking-widest text-yellow-400 mb-2">
              Tài khoản
            </p>
      ...
      <div className="flex-1 overflow-hidden">
        ...
        {/* TOPBAR */}
        <div className="h-[72px] border-b border-white/10 px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div
              className="px-4 h-10 rounded-full flex items-center text-xs font-bold"
              style={{
        ...
        <div className="p-6 overflow-y-auto h-[calc(100vh-72px)]">
          ...
          {/* HERO */}
          <div
            className="relative overflow-hidden rounded-3xl border border-white/10 p-8 mb-6"
            style={{
              background:
          ...
          >
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              ...
              <div className="max-w-2xl">
                ...
                <p className="text-white/50 mt-4 leading-relaxed text-sm max-w-xl">
                ...
                <div className="flex flex-wrap gap-3 mt-6">
                  <Link
                    to="/appointments/new"
                    className="px-5 h-11 rounded-full flex items-center text-sm font-bold"
                    style={{
                      background: "#D4A843",
                      color: "#1a0000",
                    }}
                  ...
                  <Link
                    to="/appointments"
                    className="px-5 h-11 rounded-full flex items-center text-sm font-semibold border border-white/10 text-white hover:bg-white/[0.05] transition"
                  >
                    Xem cuộc hẹn
                  </Link>
                </div>
